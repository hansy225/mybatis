...
public class PageInfo {
	...
	private int numPerPage;   // 현재 페이지에 보여줄 게시글의 최대 갯수(5)
	private int pagePerBlock; //페이지 하단에 보여질 페이징 바의 페이지 최대 갯수(5)
	 
	private int totalPage;    // 가장 마지막 페이지(총 페이지 수) =>6
	private int startPage;    // 하단에 페이징 바의 시작 페이지
	private int endPage;      // 하단에 페이징 바의 끝 페이지
